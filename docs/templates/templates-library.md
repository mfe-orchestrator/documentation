...
description: "The catalogue of working Module Federation projects you pick from when creating a microfrontend: build config, a sample component and a matching CI pipeline."
