...
description: Create an account, connect a repository and create your first microfrontend with MFE Orchestrator — hosted console or self-hosted, one step at a time.
