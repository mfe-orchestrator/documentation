...
5. Create your organization, then set your first project name
...
- **[Build status](./deployments/build-status.md)** — every microfrontend, its latest CI run and the
  version each environment serves, on one page
