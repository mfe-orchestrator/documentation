...
description: "Connect object storage you own, on Amazon S3, Azure Blob Storage or Google Cloud Storage, so microfrontend builds land in your cloud account, not the platform."
