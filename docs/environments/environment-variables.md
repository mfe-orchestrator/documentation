...
description: "Runtime key/value pairs scoped to an environment and read by the browser after the bundle loads, so one build can be configured differently in each stage."
